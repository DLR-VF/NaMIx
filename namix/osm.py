...
@description Downloads road networks from OSM
...
def get_network(polygon, network_type, custom_filter=None, simplify=False, verbose=0):
    """
    Download street network from osm via osmnx.
     ...
     :param network_type: can be "all_private", "all", "bike", "drive", "drive_service", "walk"
                         (see osmnx for description)
